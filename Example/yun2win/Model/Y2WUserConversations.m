...
- (void)setup {
    RLMResults *results = [[UserConversationBase objectsInRealm:self.user.realm where:@"isDelete == %d", NO]
...
- (Y2WUserConversation *)getUserConversationById:(NSString *)userConversationId {
    for (Y2WUserConversation *userConversation in self.getUserConversations) {
