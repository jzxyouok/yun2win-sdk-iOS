...
- (void)reloadData {
    ...
    SettingTableViewCellModel *fileModel = [[SettingTableViewCellModel alloc] init];
    fileModel.title = @"群文件";
    fileModel.cellClass = [SettingTableViewCell class];
    fileModel.cellAction = @selector(clickGroupFile);
    fileModel.rowHeight = 50;
    fileModel.showAccessory = YES;
    [sectons addObject:@[fileModel]];
...
//    SettingTableViewCellModel *favor = [[SettingTableViewCellModel alloc] init];
//    favor.title = @"收藏群";
//    favor.cellClass = [FavorGroupCell class];
////    favor.cellAction = @selector(clickSessionsName);
//    favor.rowHeight = 50;
//    favor.showAccessory = self.isFavorGroup;
//    [sectons addObject:@[favor]];
