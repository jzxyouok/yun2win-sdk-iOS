...
- (void)reloadData {
    ...
    SettingTableViewCellModel *help = [[SettingTableViewCellModel alloc] init];
    help.title = @"帮助";
    help.cellClass = [SettingTableViewCell class];
    help.cellAction = @selector(clickHelp);
    help.rowHeight = 50;
    help.showAccessory = YES;
    [sectons addObject:@[help]];
