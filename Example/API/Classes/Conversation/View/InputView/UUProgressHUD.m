...
//        centerImageView.image = [UIImage imageNamed:@"录制语音-0"];
        centerImageView.highlightedImage = [UIImage imageNamed:@"录音取消发送"];
        centerImageView.animationImages = @[[UIImage imageNamed:@"录制语音-0"],
                                            [UIImage imageNamed:@"录制语音-1"],
                                            [UIImage imageNamed:@"录制语音-2"],
                                            [UIImage imageNamed:@"录制语音-3"],
                                            [UIImage imageNamed:@"录制语音-4"],
                                            [UIImage imageNamed:@"录制语音-5"],
                                            [UIImage imageNamed:@"录制语音-6"]];
